...
query_params = {'query': '(#aiart OR #aiイラスト) has:media -is:retweet', 'expansions': 'attachments.media_keys', 'tweet.fields': 'author_id,created_at,public_metrics,possibly_sensitive', 'media.fields': 'url', 'max_results': max_results}
file_name = 'AI_test'
folder = r'C:\Users\Tagami\OneDrive\Documents\GitHub\ai_art_classification_model/Ai_script'
urls_file = r'C:\Users\Tagami\OneDrive\Documents\GitHub\ai_art_classification_model\Ai_script\ai_urls_list.py'
loop_count = 1
sleep_duration = 20
