...
def download_image_list(image_urls, image_url_count, folder, file_name, sleep_dur):
...
def main():
     download_image_list(filtered_urls, image_url_count, folder, file_name, sleep_dur)
